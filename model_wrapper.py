...
class GAN:
    ...
    def minmax_generator_loss(self, x_t1, x_t1_hat, Y_hat_fake, lambda1=1.0, lambda2=1.0, summaries=False):
        """
        ...
        Y_hat_fake : TYPE
            Ouput or discrminator which is extracted using gan(combined model), not the discriminator only.
